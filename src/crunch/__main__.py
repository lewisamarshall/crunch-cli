...
from crunch.commands import lm as lm_cmd
from crunch.commands import load as load_cmd
...
from crunch.commands import write as write_cmd
...
app.command("load")(load_cmd.main)
app.command("write")(write_cmd.main)
